...
HD_PWD='C:/Disco1/RepositoriosGitHub/ProyectoMyS/Sistema_pwmModule_ip/Sintesis/sistema_pwmModule.runs/sistema_pwm_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sistema_pwm_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sistema_pwm_rst_ps7_0_100M_0.tcl
