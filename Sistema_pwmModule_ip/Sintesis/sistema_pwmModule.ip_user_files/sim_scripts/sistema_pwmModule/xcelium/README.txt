...
#
# Generated by export_simulation on Fri Oct 11 12:34:09 -0300 2024
#
################################################################################
...
'-reset_run' switch to the './sistema_pwmModule.sh' script.

./sistema_pwmModule.sh -reset_run
...
./sistema_pwmModule.sh -noclean_files

For more information on the script, please type './sistema_pwmModule.sh -help'.
