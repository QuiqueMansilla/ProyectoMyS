...
HD_PWD='C:/Disco1/RepositoriosGitHub/ProyectoMyS/Sistema_pwmModule_ip/Sintesis/Sistema_pwmModule_ip.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sistema_pwmModule_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sistema_pwmModule_wrapper.tcl -notrace
