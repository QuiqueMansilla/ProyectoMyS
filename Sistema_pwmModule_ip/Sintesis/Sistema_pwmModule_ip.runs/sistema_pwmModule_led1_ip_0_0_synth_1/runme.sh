...
HD_PWD='C:/Disco1/RepositoriosGitHub/ProyectoMyS/Sistema_pwmModule_ip/Sintesis/Sistema_pwmModule_ip.runs/sistema_pwmModule_led1_ip_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sistema_pwmModule_led1_ip_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sistema_pwmModule_led1_ip_0_0.tcl
